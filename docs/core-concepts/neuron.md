...
> **Note**: This is a developer-maintained documentation page. The content here is not auto-generated and should be updated manually to explain the core concepts and architecture of the neuron package.
...
- [API Reference](../api-reference/neuron.md) - Complete API documentation
